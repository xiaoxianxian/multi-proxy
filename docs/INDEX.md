...
| `docs/04-business/vetarai-competitive-analysis.md` | `docs/04-business/` | 竞品分析（VetarAI 对标 + 结论 + 迭代 Backlog I1–I5 + **§八 I1 接口草图**，精确到 orchestrator 注入缝 / manager 真实路径；2026-09-23，分析留底待开发） |
